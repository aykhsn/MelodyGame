class HomeButton {
    ...
    createModal() {
        ...
        const modalHeight = modalWidth * 3 / 4;
        ...
        // ストロークを追加（淡い緑色）
        this.modalBackgroundRect.lineStyle(modalWidth / 40, 0x94E7FC); // 4ピクセルの太さで淡い緑色 (LightGreen)
        ...
        this.closeButton = this.scene.add.image(modalWidth / 2 - 10, -modalHeight / 2 + 10, 'modal-close')
            .setInteractive()
            .setScale(buttonSize * 0.6 / this.scene.textures.get('modal-close').getSourceImage().width)
